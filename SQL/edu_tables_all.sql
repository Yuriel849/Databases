/*------------------------------------------------------------------------------
-- 개체 이름: Yuriel.S_CUSTOMER
-- 만든 날짜: 2017-08-23 오후 10:05:01
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:06:26
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_CUSTOMER CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_CUSTOMER (
...
ALTER TABLE Yuriel.S_CUSTOMER ADD
(
...
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_EMP CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_EMP (
  ID               NUMBER(7)             NOT NULL, 
...
GRANT SELECT ON Yuriel.S_EMP TO TEST WITH GRANT OPTION;

GRANT INSERT ON Yuriel.S_EMP TO TEST WITH GRANT OPTION;



/*------------------------------------------------------------------------------
-- 개체 이름: Yuriel.SALGRADE
-- 만든 날짜: 2017-08-23 오후 10:00:38
-- 마지막으로 수정한 날짜: 2017-08-30 오전 11:34:57
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.SALGRADE CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.SALGRADE (
...
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_DEPT CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_DEPT (
  ID           NUMBER(7)             NOT NULL, 
  NAME         VARCHAR2(25 BYTE)     NOT NULL, 
  REGION_ID    NUMBER(7)                 NULL
)
...
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_ITEM CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_ITEM (
...
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_ORD CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_ORD (
  ID              NUMBER(7)            NOT NULL, 
...
/*------------------------------------------------------------------------------
-- 개체 이름: Yuriel.S_PRODUCT
-- 만든 날짜: 2017-08-23 오후 9:59:21
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:07:20
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_PRODUCT CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_PRODUCT (
  ID            NUMBER(7)              NOT NULL, 
  NAME          VARCHAR2(50 BYTE)      NOT NULL, 
...
ALTER TABLE Yuriel.S_PRODUCT ADD
(
...
/*------------------------------------------------------------------------------
-- 개체 이름: Yuriel.S_REGION
-- 만든 날짜: 2017-08-23 오전 10:37:32
-- 마지막으로 수정한 날짜: 2017-08-23 오후 10:07:32
-- 상태: VALID
------------------------------------------------------------------------------*/
DROP TABLE Yuriel.S_REGION CASCADE CONSTRAINTS;

CREATE TABLE Yuriel.S_REGION (
  ID      NUMBER(7)             NOT NULL, 
...
ALTER TABLE Yuriel.S_REGION ADD
(
